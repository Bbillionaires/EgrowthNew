  ...
  return (
    <footer className="relative z-10 bg-white pt-16 dark:bg-gray-dark md:pt-20 lg:pt-24">
      <div className="container">
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
            <div className="mb-12 max-w-[360px] lg:mb-16">
              ...
              <p className="mb-9 text-base leading-relaxed text-body-color dark:text-body-color-dark">eGrowthNow empowers nonprofit organizations to maximize their impact through technology and expert support.</p>
            </div>
          </div>
        ...
        <div className="py-8">
          <p className="text-center text-base text-body-color dark:text-white">© {new Date().getFullYear()} eGrowthNow. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
